...
stdenv.mkDerivation {
  ...
  buildPhase = ''
    ...
    clang -O3 -Wall src/discord_snowflake_parse.c -o build_stage/bin/discord_snowflake_parse
    clang -O3 -Wall -nostdlib -fno-builtin src/password_gen.c -o build_stage/bin/password_gen
  '';
